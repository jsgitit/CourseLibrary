        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            .ConfigureApiBehaviorOptions(setupAction => 
            {
                setupAction.InvalidModelStateResponseFactory = context =>
                {
                    ...
                    // we're dealing with a null or unparsable object input so return status 400
            ...
            // register custom PropertyCheckerService
            ...
            else
            {
                app.UseExceptionHandler(appBuilder =>
                {
                    appBuilder.Run(async context =>
                    {
                        ...
                        // TODO: log the fault as well
                    });
                });
            }

            //app.UseResponseCaching();  // response caching only got us part way there.
